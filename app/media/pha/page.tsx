...
const phaIntros = [
  { title: "Aotearoa", src: "/videos/pha/aotearoa.mp4" },
  { title: "Fiji", src: "/videos/pha/fiji.mp4" },
  { title: "Hawaii", src: "/videos/pha/hawaii.mp4" },
  { title: "Samoa", src: "/videos/pha/samoa.mp4" },
  { title: "Tahiti", src: "/videos/pha/tahiti.mp4" },
  { title: "Tonga", src: "/videos/pha/tonga.mp4" },
];
      ...
      <div className={styles.featuredVideo}>
        <div className={styles.videoWrapper}>
          <video
            ...
            playsInline
          >
            <source src="/videos/pha/wide-warriors.mp4" type="video/mp4" />
          </video>
        </div>
